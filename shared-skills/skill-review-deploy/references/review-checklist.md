...
SKILL_LIST="apf-warning-design apf-warning-impl cowork-remote etap-build-deploy genai-apf-pipeline genai-frontend-inspect genai-warning-pipeline test-pc-worker workflow-retrospective"
```
