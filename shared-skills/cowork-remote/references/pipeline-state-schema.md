...
> **`terminate:*` next_action family** (2026-04-28 21차 추가) — 자율 loop 관점 terminal 상태. WSA v2 filter: `not startswith('defer:') AND not startswith('terminate:')`. Service profile (cause_pointer) 가 full evidence 보유. 사례:
